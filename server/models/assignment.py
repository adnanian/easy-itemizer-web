...
class Assignment(db.Model, SerializerMixin):
    ...
    current_quantity = db.Column(db.Integer, db.CheckConstraint('count >= 0', name='check_count_constraint'), nullable=False)
    enough_threshold = db.Column(db.Integer, db.CheckConstraint('count >= 1', name='check_threshold_constraint'), nullable=False)
