...
class AssignmentResource(Resource):
    def post(self):
        ...
        When a new assignment is created, a log will be entered for the organization
        tied to i.
        ...
        try:
            ...
            db.session.commit()
            return {"assignment_l": {"assignment": new_assignment.to_dict()}}, 201
...
class AssignmentById(DRYResource):
    ...
    When an assignment is updated or deleted, a log will be entered for the organization tied to the
    assignment.
